...
resource "azurerm_linux_virtual_machine" "www_basvm" {
  ...
  size                  = "Standard_B1s"
  admin_username        = "www"
  network_interface_ids = [var.subnet_www_bas_nic]
...
resource "azurerm_linux_virtual_machine" "www_web1vm" {
  ...
  size                  = "Standard_B1s"
  admin_username        = "www"
  network_interface_ids = [var.subnet_www_web1_nic]
...
resource "azurerm_linux_virtual_machine" "www_web2vm" {
  ...
  size                  = "Standard_B1s"
   admin_username        = "www"
  network_interface_ids = [var.subnet_www_web2_nic]
...
resource "azurerm_linux_virtual_machine" "www_dbvm" {
  ...
  admin_username        = "www"
  network_interface_ids = [var.subnet_www_db_nic]
...
resource "azurerm_linux_virtual_machine" "www_vnet1_web1vm" {
  ...
  size                  = "Standard_B4as_v2"
  admin_username        = "www"
  network_interface_ids = [var.subnet_www_web1_v1_nic]
