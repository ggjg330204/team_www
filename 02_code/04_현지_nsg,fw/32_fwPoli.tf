...
resource "azurerm_firewall_policy_rule_collection_group" "www_fwporcg" {
  ...
  network_rule_collection {
    ...
    rule {
      name                  = "netrc1-ssh"
      protocols             = ["TCP"]
      source_addresses      = ["61.108.60.26", "10.0.0.0/16", "172.17.0.0/16", "10.1.0.0/16", "172.16.0.0/16"] #경기인력개발원, bas vnet, fw vnet, web vnet, was vnet, db vnet
      destination_addresses = ["10.0.0.0/16", "172.17.0.0/16", "10.1.0.0/16", "172.16.0.0/16"]
