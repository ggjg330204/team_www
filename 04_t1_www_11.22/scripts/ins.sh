...
dnf install -y wget httpd php php-gd php-opcache php-mysqlnd lynx
...
sed -i 's/localhost/10.0.5.10/g' /var/www/html/wp-config.php
sed -i 's/10.0.5.4/10.0.5.10/g' /var/www/html/wp-config.php
