...
output "www_custom_domain_validation_token" {
  description = "Validation token for www.04www.cloud - Add this as TXT record: _dnsauth.www.04www.cloud"
  value       = azurerm_cdn_frontdoor_custom_domain.www_custom_domain.validation_token
}

output "apex_custom_domain_validation_token" {
  description = "Validation token for 04www.cloud - Add this as TXT record: _dnsauth.04www.cloud"
