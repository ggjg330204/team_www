...
module "network_central" {
  ...
  frontdoor_endpoint_hostname = module.storage.frontdoor_endpoint_hostname
...
module "security" {
  ...
  appgw_identity_principal_id = module.network_central.appgw_identity_principal_id
  enable_appgw               = module.network_central.enable_appgw // Assuming enable_appgw is an output from network_central
}
module "storage" {
