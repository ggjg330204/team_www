...
**[SOAR 자동화 알림]**
- **Logic App Playbook**: `sentinel-incident-email` - 인시던트 트리거 기반 사용자 지정 워크플로우 실행
- **Automation Rule**: 인시던트 생성 시 Playbook 자동 실행 및 상태를 'Active'로 전환
- **Action Group**: `sentinel-alert-email` (기본 알림 채널)
