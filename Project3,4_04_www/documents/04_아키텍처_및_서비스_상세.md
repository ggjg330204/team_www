...
│   ├── Identity/              # [계정] Entra ID Users, Roles
...
| | `azurerm_sentinel_alert_rule_scheduled` | 14 | 보안 위협 탐지 규칙 |
...
| **Identity** | `azurerm_user_assigned_identity` | 2+ | AppGw, VMSS용 관리 ID |
...
- **Access Policy**: RBAC 기반 제어 (User Assigned Identity 연동)
